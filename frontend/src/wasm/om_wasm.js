 ...
 * @returns {string}
 */
export function parse_document_json(source, path) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        wasm.parse_document_json(retptr, ptr0, len0, ptr1, len1);
 ...
 * @returns {string}
 */
export function render_project_json(source, path, annotations_json) {
    let deferred5_0;
    let deferred5_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        ...
        wasm.render_project_json(retptr, ptr0, len0, ptr1, len1, ptr2, len2);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('om_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
